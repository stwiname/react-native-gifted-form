...
import {
  View, ListView, Text, TouchableHighlight, TextInput, Image, StyleSheet
} from 'react-native';

import WidgetMixin from '../mixins/WidgetMixin';
import OptionWidget from './OptionWidget.js';
...
export default class SelectCountryWidget extends WidgetMixin {
  ...
  static getCountryNameByAlpha2(code) {
  ...
  static getCountryFlagByAlpha2(code) {
    var image = null;
  ...
  renderRow(rowData, sectionID, rowID) {
    ...
    const image = SelectCountryWidget.getCountryFlagByAlpha2(rowData.alpha2);
